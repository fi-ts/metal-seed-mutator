...
openssl req -new -key webhookCA.key -subj "/CN=metal-seed-mutator.default.svc"  -out webhookCA.csr
...
sed "s/REGISTRY/${REGISTRY}/" deployment.yaml.tpl > deployment.yaml
